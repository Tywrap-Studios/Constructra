...
=== "Building"
    You can do this by cloning the repository and running `./gradlew build` in the root directory of the project. Your jar will be in a folder called `build/libs`
    !!! warning
...
=== "GitHub Actions"
    ...
    2. On the left hand side, you see a list of Workflows/Actions, click the one named `build`.
